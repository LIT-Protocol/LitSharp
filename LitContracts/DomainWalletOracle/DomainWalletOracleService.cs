...
namespace LitContracts.DomainWalletOracle
{
    public partial class DomainWalletOracleService
    {
        ...
        public Task<string> SetAdminRequestAsync(string acct)
        {
            var setAdminFunction = new SetAdminFunction();
                setAdminFunction.Acct = acct;
            
             return ContractHandler.SendRequestAsync(setAdminFunction);
        }

        public Task<TransactionReceipt> SetAdminRequestAndWaitForReceiptAsync(string acct, CancellationTokenSource? cancellationToken = null)
        {
            var setAdminFunction = new SetAdminFunction();
                setAdminFunction.Acct = acct;
