...
namespace LitContracts.WLIT.ContractDefinition
{


    public partial class WlitDeployment : WlitDeploymentBase
    {
        public WlitDeployment() : base(BYTECODE) { }
        public WlitDeployment(string byteCode) : base(byteCode) { }
    }

    public class WlitDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "0x";
        public WlitDeploymentBase() : base(BYTECODE) { }
        public WlitDeploymentBase(string byteCode) : base(byteCode) { }
